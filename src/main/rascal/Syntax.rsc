...
start syntax Planning = planning: 'Persons:' Person+ persons Task+ tasks;

syntax Person = person: ID name '{' Role role ',' 'age' INT age '}';

syntax Role = manager: 'Manager'
            | employee: 'Employee';
...
keyword Reserved = "Persons:" | "Person" | "Task" | "priority:" | "person" | "duration:" 
                 | "Lunch" | "Meeting" | "Report" | "Pay" | "euro" 
                 | "min" | "hour" | "day" | "week" | "Manager" | "Employee" | "age";